...
**Deadline:** 23h59 09/04/2026 | **Nộp lên:** LMS | **Nộp link public GitHub repo**
...
- **Folder `canhan/extras/`** không bắt buộc — nộp thêm các output cá nhân khác (prompt test logs, design sketches, research notes, screenshot AI conversation...) sẽ được xét **bonus điểm** nếu nội dung có chất lượng và thể hiện quá trình tư duy.
...
- [ ] Repo đặt tên đúng: `MaHocVien-HoTen-Day06`
- [ ] Folder `canhan/` có: `feedback.md` + `reflection.md`
- [ ] Folder `NhomXX-Room/` có: `spec-final.md` + `prototype-readme.md` + `demo-slides.pdf`
- [ ] SPEC đủ 6 phần
